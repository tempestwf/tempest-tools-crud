...
$controllerConfig = [
    '<string>'=>[ // Context keys may be layered as deep as you like. They are part of the contextual config nature of Scribe. See documentation for more details.
        '<"GET" | "POST" | "PUT" | "DELETE" >'=> [ // GET, POST, PUT, DELETE. Corresponds to the request method used
            ...
            'allowed'=>'<boolean>', // Defaults to true. Whether or not the type of request is allowed.
            'allowIndex'=>'<boolean>', // Defaults to true. Whether or not the index is allowed to be accessed. Should only be added to GET blocks of the config
